...
describe UsersController, type: :controller do
  ...
  describe 'POST #create' do
    context 'valid attributes' do
      let(:valid_attributes) { { name: "Laila Zaki", email: "laila@gmail.com",
  ...
  describe 'PATCH #update' do
    ...
    context 'valid attributes' do
      it 'updates user' do
        patch :update, id: user_for_edit.id, user: { name: 'Lailac Zucchini' }
        user_for_edit.reload
        expect(user_for_edit.name).to eq('Lailac Zucchini')
      end
    ...
    context 'invalid attributes' do
      it 'does not update user' do
        ...
        user_for_edit.reload
        expect(user_for_edit.name).to eq('Laila Zaki') 
      end
  ...
  describe 'DELETE #destroy' do
    it 'deletes requested user' do
      user_for_removal = User.create(name: "Laila Zaki", email: "laila@gmail.com",
                          password: "foobar", password_confirmation: "foobar")
      expect{
